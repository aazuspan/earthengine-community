...
[Open in the Code Editor](https://code.earthengine.google.com/82cd7b089f029c2048dffc827b33756e)
...
2. Using a [`linearFit`](https://developers.google.com/earth-engine/apidocs/ee-reducer-linearfit) reducer calculate regression coefficients between the masked images in the area of interest.
...
Mapping that function the list of `bands` defined at the beginning of the tutorial will return a list of matched single-band images, which can then be combined back into a multi-band image.
...
The full code is below, or you can [open it in the Code Editor](https://code.earthengine.google.com/82cd7b089f029c2048dffc827b33756e).
